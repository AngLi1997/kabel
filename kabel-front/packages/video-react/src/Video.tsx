...
import type { MediaAnnotatorProps, MediaAnnotatorRef } from '@kabel/components-react';
import { MediaAnnotator, MediaAnnotationContext, AttributeOverlay, parseTime } from '@kabel/components-react';
