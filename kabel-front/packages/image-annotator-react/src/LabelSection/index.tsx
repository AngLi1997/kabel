...
import type { DraggableModalRef, ValidationContextType } from '@kabel/components-react';
import { Kbd, getOS, DraggableModel, AttributeForm, EllipsisText, FlexLayout } from '@kabel/components-react';
import { useTranslation } from '@kabel/i18n';
import type { Attribute, AttributeValue, EnumerableAttribute, ILabel, TextAttribute } from '@kabel/interface';
import type { AnnotationData, Annotator, ToolName } from '@kabel/image';
