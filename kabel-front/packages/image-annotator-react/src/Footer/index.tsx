...
import { Tooltip } from '@kabel/components-react';
...
function Content() {
  ...
  return (
    <ContentBody>
      <PropertyWrapper>
        <TitleWrapper>
          <SaturationIcon className="kabel-svg-icon" />
          {t('saturation')}
        </TitleWrapper>
      ...
      <PropertyWrapper>
        <TitleWrapper>
          <ContrastIcon className="kabel-svg-icon" />
          {t('contrast')}
        </TitleWrapper>
      ...
      <PropertyWrapper>
        <TitleWrapper>
          <BrightnessIcon className="kabel-svg-icon" />
          {t('exposure')}
        </TitleWrapper>
    ...
    <FooterBar>
      <Left>
        ...
        <Tooltip overlay={<Content />} overlayStyle={tooltipStyle} placement="topLeft">
          <BarItem>
            <SettingIcon className="kabel-svg-icon" />
            {t('adjustment')}
          </BarItem>
        </Tooltip>
      </Left>
      <Right>
        ...
        >
          <FitContainerIcon className="kabel-svg-icon" />
          {t('fitContainer')}
        </BarItem>
        <BarItem
          onClick={() => {
        ...
        >
          <ScaleResetIcon className="kabel-svg-icon" />
          {t('rawScale')}
        </BarItem>
        <BarItem onClick={handleRotate}>
          <RotateIcon className="kabel-svg-icon" />
          {t('rotate')}
        </BarItem>
      </Right>
    </FooterBar>
