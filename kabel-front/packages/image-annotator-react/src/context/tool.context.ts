import type { ToolName, Annotator as ImageAnnotator, EditType } from '@kabel/image';
import type { EnumerableAttribute, TextAttribute, ILabel, Attribute } from '@kabel/interface';
