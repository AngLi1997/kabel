...
export class DraftCuboid extends Draft<CuboidData, PolygonStyle | PointStyle> {
  ...
  private _handleMouseOver = (e: MouseEvent) => {
    const otherPerspective = document.getElementById('kabel_cuboid_other_perspective');
    const moreWrapper = document.getElementById('kabel_cuboid_more');
  ...
  private _handleSwitchDirection = (e: MouseEvent) => {
    ...
    const frontBackSwitcher = document.getElementById('kabel_cuboid_switch_front_back');
    const leftSwitcher = document.getElementById('kabel_cuboid_left');
    const rightSwitcher = document.getElementById('kabel_cuboid_right');
    const topSwitcher = document.getElementById('kabel_cuboid_top');
    const target = e.target as HTMLElement;
