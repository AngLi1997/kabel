...
#kabel_cuboid_more_icon {
  padding: 8px 0;
}

#kabel_cuboid_other_perspective {
  display: none;
  height: 28px;
  border-radius: 2px;
  background-color: #FFFFFF;
...
.kabel-css-tooltip-toggle {
  cursor: pointer;
  position: relative;
}

.kabel-css-tooltip-toggle::before, .kabel-css-tooltip-toggle::after {
...
.kabel-css-tooltip-toggle:focus::before, .kabel-css-tooltip-toggle:focus::after, .kabel-css-tooltip-toggle:hover::before, .kabel-css-tooltip-toggle:hover::after {
  opacity: 1;
}

.kabel-css-tooltip-toggle::before {
  position: absolute;
  top: 0;
  left: 50%;
...
.kabel-css-tooltip-toggle::after {
  position: absolute;
  top: -12px;
  left: 9px;
...
<div id="kabel_cuboid_switch_inner">
<div id="kabel_cuboid_switch_front_back"  class="kabel-css-tooltip-toggle" aria-label="切换前后面">
  <div class="kabel-cuboid-icon">
...
<div id="kabel_cuboid_more">
  <div id="kabel_cuboid_more_icon" class="kabel-cuboid-icon">
  ...
  <div id="kabel_cuboid_other_perspective">
    <div id="kabel_cuboid_right" class="kabel-cuboid-icon kabel-css-tooltip-toggle" aria-label="切换到右侧面">
    ...
    <div id="kabel_cuboid_left" class="kabel-cuboid-icon kabel-css-tooltip-toggle" aria-label="切换到左侧面">
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M16.425 5.04961C16.35 4.82461 16.2 4.67461 15.975 4.59961L9.525 1.14961C9.225 0.999609 8.85 0.999609 8.55 1.14961L2.025 4.59961C1.725 4.74961 1.5 5.12461 1.5 5.49961V12.2496C1.5 12.6246 1.725 12.9996 2.025 13.1496L8.475 16.5996C8.7 16.6746 8.925 16.7496 9.15 16.6746C9.225 16.6746 9.375 16.5996 9.45 16.5996L15.9 13.1496C16.275 12.9996 16.5 12.6246 16.5 12.2496V5.49961C16.5 5.34961 16.425 5.19961 16.425 5.04961ZM9.15 8.87461V15.2496L9 15.3996L2.85 12.0996V5.64961L9 2.34961L15.15 5.64961L9.15 8.87461Z"
          fill="#1B67FF"></path>
    ...
    <div id="kabel_cuboid_top" class="kabel-cuboid-icon kabel-css-tooltip-toggle" aria-label="切换到顶面">
