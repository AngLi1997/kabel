...
const TaskList = () => {
  ...
  const kabelVersion = _.get(routerLoaderData, ['headers', 'kabel-version']);
  ...
  return (
    <Wrapper flex="column">
            ...
            message={
              <div>
                ...
                <a
                  ...
                  href={`https://opendatalab.github.io/Kabel/${
      ...
      <Footer flex="row" items="flex-between" justify="space-between">
        <AppVersion>
          <Popover content={versionInfo}>kabel@{kabelVersion}</Popover>
        </AppVersion>
