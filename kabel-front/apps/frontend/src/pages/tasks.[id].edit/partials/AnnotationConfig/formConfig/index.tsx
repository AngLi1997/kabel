// import { ImageToolName, TOOL_NAME, EVideoToolName, EAudioToolName } from '@kabel/annotation';
...
const GlobalStyle = createGlobalStyle`
  .kabel-tool-select-popup .rc-virtual-list-holder {
    ...
    >
      ...
      <Form.Item label={t('annotationTool')}>
        <Select
          ...
          popupClassName="kabel-tool-select-popup"
          options={toolsMenu}
