...
import { Annotator } from '@kabel/video-annotator-react';
import type { AudioAndVideoAnnotatorRef } from '@kabel/audio-annotator-react';
import { Annotator as AudioAnnotator } from '@kabel/audio-annotator-react';
import { useSearchParams, useParams, useRouteLoaderData } from 'react-router-dom';
import { Bridge } from 'iframe-message-bridge';
import type { ImageAnnotatorProps, AnnotatorRef as ImageAnnotatorRef } from '@kabel/image-annotator-react';
import { Annotator as ImageAnnotator } from '@kabel/image-annotator-react';
import { useIsFetching, useIsMutating } from '@tanstack/react-query';
import { FlexLayout } from '@kabel/components-react';
import type { ToolName } from '@kabel/image';
import type { ILabel } from '@kabel/interface';
...
const AnnotationPage = () => {
  ...
  const [samples = [] as SampleResponse[], loading, setSamples, svc] = useScrollFetch(
    fetchSamples,
    () =>
      document.querySelector('.kabel-image__sidebar div') ||
      document.querySelector('.kabel-audio__sidebar div') ||
      document.querySelector('.kabel-video__sidebar div'),
    {
