"""
Kabel Model Server — SAM 3 (Segment Anything with Concepts)
...
app = FastAPI(title="Kabel SAM 3 Model Server")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Kabel SAM 3 Model Server")
