"""
Kabel Model Server — GroundingDINO + SAM
...
Implements the Kabel auto-label model API protocol:
...
app = FastAPI(title="Kabel GroundingDINO + SAM Model Server")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Kabel GroundingDINO + SAM Model Server")
