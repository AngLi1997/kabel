...
from kabel.internal.adapter.persistence import crud_pre_annotation, crud_sample, crud_task
from kabel.internal.adapter.persistence import crud_auto_label_job
...
from kabel.internal.common.storage import get_model_read_url
from kabel.internal.common.config import settings
from kabel.internal.domain.models.auto_label_job import AutoLabelStatus
from kabel.internal.domain.models.pre_annotation import TaskPreAnnotation
from kabel.internal.domain.models.task import MediaType
...
def _get_image_url(attachment) -> str:
    ...
    if getattr(attachment, "data_source_id", None) and getattr(attachment, "data_source", None):
        from kabel.internal.application.service.datasource import get_presigned_url
