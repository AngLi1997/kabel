...
from kabel.internal.application.response.pre_annotation import CreatePreAnnotationResponse, PreAnnotationFileResponse
from kabel.internal.application.response.pre_annotation import PreAnnotationResponse
...
def read_pre_annotation_file(attachment: TaskAttachment) -> List[dict]:
    ...
    try:
        ...
        raise KabelException(status_code=404, code=ErrorCode.CODE_51001_TASK_ATTACHMENT_NOT_FOUND)
