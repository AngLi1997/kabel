...
from kabel.internal.application.service import attachment as service
from kabel.internal.application.command.attachment import AttachmentCommand
from kabel.internal.application.command.attachment import AttachmentDeleteCommand
...
from kabel.internal.application.response.attachment import AttachmentResponse
...
async def get_content(file_path: str, range: str = Header(None)):
    ...
    except (FileNotFoundError, OSError, KabelException):
