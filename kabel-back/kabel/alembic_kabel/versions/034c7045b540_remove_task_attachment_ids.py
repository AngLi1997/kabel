...
def upgrade() -> None:
    ...
    # fix the unnecessary column from: https://github.com/opendatalab/Kabel/blob/v1.2.1/kabel/alembic_kabel/versions/2eb983c9a254_add_collaborators_and_updaters.py#L143
